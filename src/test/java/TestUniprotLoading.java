...
//    }
    ...
    /** 2014-08-19 19:38:02,268 ERROR [org.hibernate.engine.jdbc.spi.SqlExceptionHelper] - <Data truncation: Data too long for column 'DESCRIPTION' at row 1>
     ...
     at org.biojava.nbio.auto.org.rcsb.uniprot.auto.load.LoadAllUniProt.main(LoadAllUniProt.java:76)
...
//    }
     ...
     * Failed to load A1KNB8
     ...
     at org.hibernate.jpa.spi.AbstractEntityManagerImpl.convert(AbstractEntityManagerImpl.java:1683)
     at org.hibernate.jpa.spi.AbstractEntityManagerImpl.persist(AbstractEntityManagerImpl.java:1187)
     at org.biojava.nbio.auto.org.rcsb.uniprot.auto.load.LoadAllUniProt.main(LoadAllUniProt.java:77)
     at sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)
     at sun.reflect.NativeMethodAccessorImpl.invoke(NativeMethodAccessorImpl.java:57)
     at sun.reflect.DelegatingMethodAccessorImpl.invoke(DelegatingMethodAccessorImpl.java:43)
     at java.lang.reflect.Method.invoke(Method.java:601)
